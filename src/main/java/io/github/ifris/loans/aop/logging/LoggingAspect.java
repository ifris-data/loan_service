package io.github.ifris.loans.aop.logging;
...
public class LoggingAspect {
     ...
     */
    @Pointcut(
        "within(@org.springframework.stereotype.Repository *)" + " || within(@org.springframework.stereotype.Service *)" + " || within(@org.springframework.web.bind.annotation.RestController *)")
     ...
     */
    @Pointcut("within(io.github.ifris.loans.repository..*)" + " || within(io.github.ifris.loans.service..*)" + " || within(io.github.ifris.loans.web.rest..*)")
